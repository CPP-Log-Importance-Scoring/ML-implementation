...
with col_title:
    st.markdown("<h1 style='margin-top:0; margin-bottom:0;'>Incident Detail & Diagnostics</h1>", unsafe_allow_html=True)
# Description spans the full width so its left edge lines up with the metabar
# and switcher below, instead of inheriting the title column's indent.
st.markdown("<p style='font-size:1.0rem; color:#475569; margin:0.35rem 0 0.9rem 0;'>Deep dive into a specific incident to understand what went wrong. View the sequence of events, potential root causes, and an AI-generated summary to help resolve the issue.</p>", unsafe_allow_html=True)
